...
import Pt2_day09.llm.LLM;
import Pt2_day09.llm.ModelCategory;
import Pt2_day09.slack.Slack;
...
public class Application {
    ...
    public static void main(String[] args) throws NoEnvException, InterruptedException, IOException, ExecutionException {
        ...
        String aiResult = llm.sendPrompt(ModelCategory.LLAMA, "What is the effects of eating strawberries and bananas for breakfast? No markdown, No escape character, nut shell");
        ...
        LLMTask reasoningTask2 = new LLMTask(
                ModelCategory.R1,
                "Write tips to use '%s' effectively for healthy breakfast meal. Without markdown and escape characters. No more than 500 characters. only use korean character and english character and use korean. Translate all Chinese and Chinese characters that can be translated into Korean if possible, and English if not possible. Finally, review your compliance with the restrictions so far."
                        .formatted(aiResult)
        );
